 ...
 * Slug: marketplace-shop/template-archive
 * Categories: template
 * Inserter: false
 */
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:66.666%"><!-- wp:query-title {"type":"archive","textAlign":"center","showPrefix":false,"align":"wide","fontFamily":"public-sans"} /-->

<!-- wp:term-description {"textAlign":"center","align":"wide","fontFamily":"public-sans"} /--></div>
<!-- /wp:column -->
...
<!-- wp:post-title {"level":4,"isLink":true,"style":{"spacing":{"margin":{"top":"var:preset|spacing|xx-small","bottom":"var:preset|spacing|xx-small"}}},"textColor":"heading","fontFamily":"public-sans"} /-->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|xx-small"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group"><!-- wp:post-author {"avatarSize":24,"showAvatar":false,"fontSize":"x-small","fontFamily":"public-sans"} /-->

<!-- wp:paragraph {"fontSize":"x-small"} -->
<p class="has-x-small-font-size">·</p>
<!-- /wp:paragraph -->

<!-- wp:post-date {"format":"M j, Y","fontSize":"x-small","fontFamily":"public-sans"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
<!-- /wp:post-template -->
...
<!-- wp:query-pagination-previous {"fontFamily":"public-sans"} /-->

<!-- wp:query-pagination-numbers {"fontFamily":"public-sans"} /-->

<!-- wp:query-pagination-next {"fontFamily":"public-sans"} /-->
<!-- /wp:query-pagination --></div>
<!-- /wp:query --></div>
<!-- /wp:column -->

<!-- wp:column {"width":"33.33%"} -->
<div class="wp-block-column" style="flex-basis:33.33%"><!-- wp:template-part {"slug":"sidebar","theme":"marketplace-shop"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></main>
<!-- /wp:group --></main>
