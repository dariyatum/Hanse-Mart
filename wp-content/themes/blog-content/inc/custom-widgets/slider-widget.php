<?php
if ( ! class_exists( 'Blog_Content_Slider_Widget' ) ) {
	/**
	 * Adds Initial Slider Slider Widget.
	 */
	class Blog_Content_Slider_Widget extends WP_Widget {
		...
		public function __construct() {
			$slider_widget = array(
				'classname'   => 'widget blog-content-widget slider-widget',
				'description' => __( 'Retrive Slider Widgets', 'blog-content' ),
			);
			parent::__construct(
				'blog_content_slider_widget',
				__( 'Artify Widget: Slider Widget', 'blog-content' ),
				$slider_widget
			);
		}
		...
		public function widget( $args, $instance ) {
			...
			?>
			<div class="widget-slider artify-navigation">
